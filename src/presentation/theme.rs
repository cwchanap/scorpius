...
pub const TARGETING_CANCEL_BACKGROUND: Color = Color::srgb_u8(42, 21, 18);
pub const TARGETING_CANCEL_BORDER: Color = Color::srgb_u8(110, 51, 43);
pub const INSPECTOR_EN_PIP_ACTIVE: Color = Color::srgb_u8(95, 200, 232);
pub const INSPECTOR_EN_PIP_INACTIVE: Color = Color::srgb_u8(27, 44, 60);
pub const INSPECTOR_EN_TEXT: Color = Color::srgb_u8(143, 191, 212);
pub const INSPECTOR_HP_TEXT: Color = Color::srgb_u8(168, 198, 180);
pub const INSPECTOR_STAT_TEXT: Color = Color::srgb_u8(169, 189, 205);
pub const INSPECTOR_PLAYER_BACKGROUND: Color = Color::srgb_u8(15, 34, 49);
pub const INSPECTOR_ENEMY_BACKGROUND: Color = Color::srgb_u8(22, 13, 13);
pub const INSPECTOR_ENEMY_BORDER: Color = Color::srgb_u8(92, 42, 36);
